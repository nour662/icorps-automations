...
1. All of the compnaies filings for the past 5 years would be downloaded to the computer
...
def search_edgar(company_name):
    ...
    #Checkst to see if the webpage is active and prints out the company name if it cannot be found
