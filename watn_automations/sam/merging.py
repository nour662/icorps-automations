...
The location of the output batches need to be identified on line 19 for merging.

Since companies were searched for by name, inaccurate records in the outputted file need to be removed in order for the 
data to display the targeted companies' information.The output file's name can be changed in the final line 
of the code by altering "sam_uncleaned_batches-10302024.csv" to the desired name. 
...
#Is used to merge all batches together, rather than a specific range of batches
df_list = []
