...
cp all_inputs/* "$inputs_folder"
find "$inputs_folder" -type f ! -name "$input_file" -delete
...
python3 sbir/sbir_scraper.py -i $inputs_folder/updated_input.csv -s 0 -o $output_folder
...
python3 usas/usas_scraper.py -i $inputs_folder/updated_input.csv -s 0 -o $output_folder
