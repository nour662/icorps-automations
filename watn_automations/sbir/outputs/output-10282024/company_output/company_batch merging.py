...
"""This script combines all of the uncleaned company information batches that are outputted by the "sbir_sttr_name_search. py"
program. It merges all the batches into a large .csv file that displays results in the following order:
